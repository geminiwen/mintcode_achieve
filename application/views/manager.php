...
<body>
	...
	<div>
		<table >
			...
			<tfoot>
				<tr style="background-color:#CDC9C9"><td><input type="checkbox" id="checkAll"></td><td><input type="submit" value="全部删除" id="deleteAll"></td><td></td><td></td><td><button onclick="window.location='manager/user'">添加新成员</button></td></tr>
			</tfoot>
		</table>
		<div id="infomation">
		</div>
