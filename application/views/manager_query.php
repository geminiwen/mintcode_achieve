...
<body>
	...
	<table class="QueryTable">
		<tr><td>日期:</td><td><input name="check_date" id="checkDate"></td></tr>
		<tr><td colspan="2"><button id="doQuery">查询</button></td></tr>
	</table>
	<div id="userinfo"></div>
	<table id="dateTable" style="display:none" class="QueryTable">
		<thead><tr><th>姓名</th><th>上班时间</th><th>上班打卡</th><th>下班时间</th><th>下班打卡</th><th>日期</th><th>备注</th></tr></thead>
		<tbody> </tbody>
		<tfoot></tfoot>
	</table>
</body>
